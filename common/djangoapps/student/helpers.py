            ...
            for subsection_key in block_data.get_children(section_key):
                    ...
                    while units:
                        ...
                        for component in components:
                            log.info(handle_xblock_callback(request, "course-v1:QUINCE+EE951-Q1+2025", "block-v1:QUINCE+EE951-Q1+2025+type@edx_sga+block@cda96a8630234195bed48e6289f07ecb", "get_staff_grading_data").readline())
