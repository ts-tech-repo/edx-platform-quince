...
urlpatterns = [
    ...
    re_path(r'^extras/start_lens', views.extras_start_lens, name = "extras_start_lens"),
...
urlpatterns += [re_path(r'^new_assessment_tracker', views.user_assessments_tracker_link, name='user_assessments_tracker_link')]
