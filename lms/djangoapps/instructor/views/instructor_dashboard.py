...
def _section_send_email(course, access):
    ...
    if helper_settings.get("ENABLE_NEW_BULK_EMAIL_EXPERIENCE", False) is not False:
        ...
        ] = f"{settings.COMMUNICATIONS_MICROFRONTEND_URL if "COMMUNICATIONS_MICROFRONTEND_URL" not in mfe_config else mfe_config["COMMUNICATIONS_MICROFRONTEND_URL"]}/courses/{str(course_key)}/bulk_email"
